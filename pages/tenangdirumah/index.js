			...
			<BodyContainer>
				...
				>
					<div className="d-lg-table mx-lg-auto">
						...
						<img
							src="./img-tenangdirumah/image_4.png"
							alt="kreavi"
							style={{ width: "204px" }}
							className=" d-block d-lg-inline-block mx-auto mx-lg-0 mr-lg-rlv-1-mobile mr-0 mb-rlv-1-mobile mb-lg-0"
						/>
						<img
							src="./img-tenangdirumah/image_3.png"
							alt="kokbisa?"
							style={{ width: "83px" }}
							className=" d-block d-lg-inline-block mx-auto mx-lg-0 mr-lg-rlv-1-mobile mr-0 mb-rlv-1-mobile mb-lg-0"
						/>
						<img
							src="./img-tenangdirumah/image_5.png"
							alt="instagram"
							style={{ width: "83px" }}
			...
			<BodyContainer>
				...
				>
					<ProductTenangDiRumah
						...
						btnText="Dapatkan Meditasi Gratis"
						btnUrl="https://play.google.com/store/apps/details?id=nozero.apps1"
