...
const AdsMeditasiPriceBox = ({
	...
	return (
		<Fragment>
			<div
				className="p-rlv-1-mobile p-lg-rlv-1-desktop mt-rlv-B mt-lg-0"
			...
			>
				...
				<p className="h5 font-weight-semibold mb-0">
					Harga Penawaran Spesial <br className="d-block d-lg-none" /> Hari Ini
				</p>
...
export default AdsMeditasiPriceBox;
