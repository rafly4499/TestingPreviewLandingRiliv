...
const HeaderKonselingPage = () => {
    ...
    `,
        ...
        fbq('track', 'PageView');`,
			...
			{/* FRESHCHAT */}
			<script dangerouslySetInnerHTML={{ __html: `<!-- FRESH CHAT -->` }} />
			<script
				dangerouslySetInnerHTML={{
			...
			/>
			<script dangerouslySetInnerHTML={{ __html: `<!-- FRESH CHAT END -->` }} />
			{/* JIVO END */}
		</Fragment>
	);
};

export default HeaderKonselingPage;
